...
<body>
	...
	<article id="content">
		...
		<%
			try {
				out.println("<h2>"+ request.getParameter("airplaneid") +"</h2>");
				...
				out.println("</table>");
				out.println("<button id=\"saveBtn\" type=\"submit\" name=\"airplaneid\" value="+request.getParameter("airplaneid")+">save</button>");
				out.println("</form>");
