...
<body>
	...
	<article id="content">
		...
		<%
			try {
				out.println("<h2>Airline ID : "+ request.getParameter("airlineid") +"</h2>");
				...
				out.println("<table class='bluetop' id=\"update_table\">");
				...
				out.println("</table>");
				out.println("<button class='bluebuttonbig' sytle='margin-top:10px;' type=\"submit\" name=\"airlineid\" value="+request.getParameter("airlineid")+">save</button>");
				out.println("</form>");
