...
<%
	...
	try{				
		String query = "select a.accountNo, a.fname, a.lname from account a where a.accountNo in (select passengerNo from eticket e where e.e_ticketid = '"+ request.getParameter("findid") +"')";
	...
	try{				
		String query = "select l.dep_airportid, l.arr_airportid, l.dep_gate, l.scheduled_dep_time, l.scheduled_arr_time,"
				...
				+ " where l.legid = e.legid and l.legid in (select ee.legid from eticket ee where ee.e_ticketid ='" + request.getParameter("findid") + "')";
		rs = stmt.executeQuery(query);
