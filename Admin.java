...
public class Admin {
	...
	public void lookupAirline() {
		while (true) {
			...
			System.out.println("|                                             |");
			System.out.println("|       1. 공항 ID로 검색하기                     |");
			System.out.println("|                                             |");
	...
	public void lookupLeg()
	{
		while (true) {
			...
			System.out.println("|                                             |");
			System.out.println("|       1. 출발 공항으로 검색하기                   |");
			System.out.println("|                                             |");
			System.out.println("|       2. 비행기 타입으로 검색하기                 |");
			System.out.println("|                                             |");
			System.out.println("|       3. 가격으로 검색하기                      |");
			System.out.println("|                                             |");
			System.out.println("|       4. Back                               |");
			System.out.println("|                                             |");
			System.out.println("+---------------------------------------------+");
	...
	public void lookupAccount() {
		while (true) {
			...
			System.out.println("|                                             |");
			System.out.println("|       1. 타입으로 검색                         |");
			System.out.println("|                                             |");
			System.out.println("|       2. 멤버십으로 검색                        |");
			System.out.println("|                                             |");
	...
	public void lookupAccountMembership() {
		while (true) {
			...
			System.out.println("|                                             |");
			System.out.println("|       1. 성별로 세부 검색하기                    |");
			System.out.println("|                                             |");
			System.out.println("|       2. 예약한 사람들만 검색하기                 |");
			System.out.println("|                                             |");
			System.out.println("|       3. 그냥 검색하기                         |");
			System.out.println("|                                             |");
			System.out.println("|       4. 멤버십 별 사람 수와 평균 여행횟수 출력      |");
			System.out.println("|                                             |");
			System.out.println("|       5. Back                               |");
			System.out.println("|                                             |");
			System.out.println("+---------------------------------------------+");
	...
	public void analysis()
	{
		...
		System.out.println("|                                             |");
		System.out.println("|                                             |");
		System.out.println("|     1. 여행 횟수가 평균보다 적은 계정 정보 조회하기    |");
		System.out.println("|                                             |");
		System.out.println("|     2. 예약된 티켓 현황을 도시 이름으로 조회하기      |");
		System.out.println("|                                             |");
		System.out.println("|     3. 특정 날짜 이후에 출발하는 모든 사람들 조회하기  |");
		System.out.println("|                                             |");
		System.out.println("|     4. N개 이상 예약된 항공권 정보 조회하기          |");
		System.out.println("|                                             |");
		System.out.println("|     5. Back                                 |");
		System.out.println("|                                             |");
		System.out.println("+---------------------------------------------+");
